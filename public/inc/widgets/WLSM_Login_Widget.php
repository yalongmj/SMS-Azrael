...
class WLSM_Login_Widget extends WP_Widget {
	public function __construct() {
		$widget_options = array(
			...
			'description' => esc_html__( 'Display login form for students.', 'school-management' ),
		);
		parent::__construct( 'wlsm_login_widget', esc_html__( 'Student Login Form', 'school-management' ), $widget_options );
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ! is_user_logged_in() ) {
			...
			esc_html_e( 'You are logged in.', 'school-management' );
			?>
	...
	public function form( $instance ) {
		$fields = array(
			'title'               => esc_html__( 'Student Login', 'school-management' ),
			'login_redirect_url'  => '',
			'logout_redirect_url' => '',
		);
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'login_redirect_url' ) ); ?>"><?php esc_html_e( 'Enter URL to redirect user after login', 'school-management' ); ?>:</label><br>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'logout_redirect_url' ) ); ?>"><?php esc_html_e( 'Enter URL to redirect user after logout', 'school-management' ); ?>:</label><br>
