		...
		<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" id="wlsm-submit-registration-form">
			...
			<div class="wlsm-form-section">
				...
				<div class="wlsm-row">
					<div class="wlsm-form-group wlsm-col-4">
							<label class="wlsm-font-bold wlsm-d-block">
								<span class="wlsm-important">*</span> <?php esc_html_e( 'Medium', 'school-management' ); ?>:
							</label>
							<?php
							foreach ( $medium_list as $key => $value ) {
								reset( $medium_list );
								?>
								<div class="wlsm-form-check wlsm-form-check-inline">
									<input class="wlsm-form-check-input" type="radio" name="medium" id="wlsm_medium_<?php echo esc_attr( $value ); ?>" value="<?php echo esc_attr( $key ); ?>" <?php checked( $key, $medium, true ); ?>>
									<label class="wlsm-ml-1 wlsm-form-check-label wlsm-font-bold" for="wlsm_medium_<?php echo esc_attr( $value ); ?>">
										<?php echo esc_html( $value ); ?>
									</label>
								</div>
								<?php
			...
			<div class="wlsm-form-section">
				...
				<div class="wlsm-row">
					<div class="wlsm-form-group wlsm-col-4">
						...
						<select name="class_id" class="wlsm-form-control wlsm_school_class wlsm_get_class_fees wlsm_school_class_subject " data-nonce="<?php echo esc_attr( wp_create_nonce( 'get-class-sections' ) ); ?>" id="">
					...
					<div class="wlsm-form-group wlsm-col-4">
						...
						<select name="subjects[]" class="wlsm-form-control " id="wlsm_subjects" multiple data-actions-box="true">
