...
<div class="wlsm">
	<div id="wlsm-get-pending-invoices-students-section">
		...
		<p>	<?php esc_html_e( 'OR', 'school-management' ); ?></p>

		<div class="wlsm-form-group wlsm-row">
		<div class="wlsm-col-4">
				<label for="wlsm_admission_number" class="wlsm-form-label wlsm-font-bold">
					<?php esc_html_e( 'Admission Number', 'school-management' ); ?>:
				</label>
			</div>
			<div class="wlsm-col-8">
				<input type="text" name="admission_number" class="wlsm-form-control" id="wlsm_admission_number" placeholder="<?php esc_attr_e( 'Enter student Admission Number', 'school-management' ); ?>">
			</div>
		</div>
